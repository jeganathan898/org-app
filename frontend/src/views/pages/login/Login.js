...
import { cilLockLocked, cilUser, cilEnvelopeClosed, cilCalendar } from '@coreui/icons'
        ...
        <CRow className="justify-content-center">
          ...
          <CCol md={8}>
            ...
            <Formik
              ...
              initialValues={{ email: "", password: "", dob: "", gender: "", password: "", firstName: "", lastName: ""  }}
              onSubmit={(values) => {
                submitLogin(values);
              }}
            >
                ...
                <CCard className="p-4">
                  <CCardBody>
                      ...
                      <CInputGroup className="mb-3">
                        ...
                        {/* <CFormInput placeholder="Last Name" name='lastName' id='lastName'  onChange={handleChange} onBlur={handleBlur} value={values.lastName} /> */}
                        {/* <DatePicker placeholder="Date of birth" name='lastName' id='lastName'  onChange={handleChange} onBlur={handleBlur} value={values.dob} /> */}
                        <DatePicker />
                        {/* <p className='error'>{errors.email && touched.email && errors.email}</p> */}
                        
                      </CInputGroup>
                      <ErrorMessage name="dob" component="p" style={{ color : 'red' }} /> 
                      <CInputGroup className="mb-3" style={{ gap:13 }}>
                        <CFormCheck type="radio" name="gender" id="gender1" label="Male"/>
                        <CFormCheck type="radio" name="gender" id="gender2" label="Female" defaultChecked/>
                      </CInputGroup>
